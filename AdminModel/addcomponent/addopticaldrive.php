...
<form method="POST">
      <!-- Modal content-->
        ...
        <div class="body">
			...
			<div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Devicetype</label>
              <input type="text" class="form-control" name="txtdevicetype" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="btnsub" value="Insert">Insert</button>
               ...
               if(isset($_POST['btnsub']))
               {
                        ...
                        $devicetype=$_POST['txtdevicetype'];
                        $price=$_POST['txtprice'];

                       $allcomponent=new addallcomponent();
                       $allcomponent->addopticaldrive($brand, $model, $devicetype, $price);
                  }
