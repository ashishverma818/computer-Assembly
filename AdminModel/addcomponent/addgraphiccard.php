...
<form method="POST">
      <!-- Modal content-->
        ...
        <div class="body">
            ...
            <div class="form-group">
              <label><span class="glyphicon glyphicon-eye-open"></span> Chipset</label>
              <input type="text" class="form-control" name="txtchipset" required>
            </div>
            <div class="form-group">
              <label><span class="glyphicon glyphicon-eye-open"></span> cpu</label>
              <input type="text" class="form-control" name="txtcpu" required>
            </div>
            <div class="form-group">
              <label><span class="glyphicon glyphicon-eye-open"></span> memory</label>
              <input type="text" class="form-control" name="txtmemory" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="btnsub" value="Insert">INSERT</button>
               ...
               if(isset($_POST['btnsub']))
               {
                       ...
                       $memory=$_POST['txtmemory'];
                        $memorytype=$_POST['txtmemory'];
                        $price=$_POST['txtprice'];

                       $allcomponent=new addallcomponent();
                       $allcomponent->addgraphicard($brand, $chipset, $cpu, $model, $memory, $price);
               }
                ?>
    </body>
