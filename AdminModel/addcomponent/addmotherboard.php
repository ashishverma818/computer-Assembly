...
<form method="POST">
      <!-- Modal content-->
        ...
        <div class="body">
			...
			<div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> chipset</label>
              <input type="text" class="form-control" name="txtchipset" required>
            </div>
            <div class="form-group">
              <label><span class="glyphicon glyphicon-eye-open"></span> form</label>
              <input type="text" class="form-control" name="txtform" required>
            </div>
            <div class="form-group">
              <label><span class="glyphicon glyphicon-eye-open"></span> socket</label>
              <input type="text" class="form-control" name="txtsocket" required>
            </div>
            <div class="form-group">
